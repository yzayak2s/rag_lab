...
async def chat_documents(vdb, question, generator, generation_kwargs, chat_with_question):
    """
    This function returns a response to a given question based on the content in the documents.

    :param generation_kwargs:
    :param chat_with_question:
    ...
    return generator.run(prompt=f"{prompted_documents['prompt']}\n{chat_with_question}", generation_kwargs=generation_kwargs)
